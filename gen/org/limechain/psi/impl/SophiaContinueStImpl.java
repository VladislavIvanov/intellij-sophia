...
public class SophiaContinueStImpl extends ASTWrapperPsiElement implements SophiaContinueSt {

  public SophiaContinueStImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitContinueSt(this);
  }
