...
public class SophiaOrOpExpressionImpl extends SophiaExpressionImpl implements SophiaOrOpExpression {

  public SophiaOrOpExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitOrOpExpression(this);
  }
