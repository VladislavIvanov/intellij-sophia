...
public class SophiaTypedAssignmentExpressionImpl extends SophiaExpressionImpl implements SophiaTypedAssignmentExpression {

  public SophiaTypedAssignmentExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitTypedAssignmentExpression(this);
  }
