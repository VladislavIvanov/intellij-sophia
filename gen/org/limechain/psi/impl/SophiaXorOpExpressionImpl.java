...
public class SophiaXorOpExpressionImpl extends SophiaExpressionImpl implements SophiaXorOpExpression {

  public SophiaXorOpExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitXorOpExpression(this);
  }
