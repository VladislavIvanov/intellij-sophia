...
public class SophiaDeclarationItemImpl extends ASTWrapperPsiElement implements SophiaDeclarationItem {

  public SophiaDeclarationItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitDeclarationItem(this);
  }
