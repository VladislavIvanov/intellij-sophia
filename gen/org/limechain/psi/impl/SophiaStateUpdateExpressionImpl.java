...
public class SophiaStateUpdateExpressionImpl extends SophiaExpressionImpl implements SophiaStateUpdateExpression {

  public SophiaStateUpdateExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitStateUpdateExpression(this);
  }
