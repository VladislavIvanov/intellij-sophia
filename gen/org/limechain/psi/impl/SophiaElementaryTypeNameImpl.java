...
public class SophiaElementaryTypeNameImpl extends SophiaTypeNameImpl implements SophiaElementaryTypeName {

  public SophiaElementaryTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SophiaMapType getMapType() {
    return findChildByClass(SophiaMapType.class);
  }
