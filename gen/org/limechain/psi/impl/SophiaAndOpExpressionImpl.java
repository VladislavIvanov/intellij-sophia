...
public class SophiaAndOpExpressionImpl extends SophiaExpressionImpl implements SophiaAndOpExpression {

  public SophiaAndOpExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitAndOpExpression(this);
  }
