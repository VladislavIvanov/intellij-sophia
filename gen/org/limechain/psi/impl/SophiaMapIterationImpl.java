...
public class SophiaMapIterationImpl extends ASTWrapperPsiElement implements SophiaMapIteration {

  public SophiaMapIterationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SophiaVisitor visitor) {
    visitor.visitMapIteration(this);
  }
